<section id="hero" class="hero">
    <div class="container">
        <div class="row text-white hero--centered">
            <div class="col-12">
                <h1 class="display-2">
                    <span class="display-2--intro">
                        Nigeria's Biggest 
                        <span class="avatar-3-wrapper">Y<span class=""><img src="/images/avatars/avatar-3.png" alt="memoji 3"></span>uth</span>
                        Gathering</span>
                    <span class="display-2--description">
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
                        Cupiditate nam cum, nemo recusandae, suscipit, non explicabo vero sit 
                        nesciunt labore animi blanditiis fugiat numquam pariatur.
                    </span>
                </h1>
                {{-- <span class="avatar-3-wrapper">Y<span><img src="/images/avatars/avatar-3.png" alt="memoji 3"></span>uth</span>
                 --}}
            </div>
...
{{--                 
                ...
                <span class="avatar avatar-8"><img src="/images/avatars/avatar-8.png" alt="memoji 8"></span> --}}
        </div>
    </div>
</section>